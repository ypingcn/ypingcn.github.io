...
最近发现 [nodePPT](https://github.com/ksky521/nodePPT) 这个用 Nodejs 做的软件，可以用来做演讲用的网页演示文稿。支持 GFM 的 markdown 语法编写 和 html 语法。生成的网页简单但很实用。
...
作者的演示网页里有详细的介绍，这里无需赘言。[nodeppt markdown 演示 - By 三水清](https://qdemo.sinaapp.com/)
