...
终端里运行在 [关于P版的PPPoE拨号问题](https://github.com/drcoms/drcom-generic/wiki/%E5%85%B3%E4%BA%8EP%E7%89%88%E7%9A%84PPPoE%E6%8B%A8%E5%8F%B7%E9%97%AE%E9%A2%98) 的HighLight部分运行所提供的命令
...
按照 [p版简略使用和配置说明](https://github.com/drcoms/drcom-generic/wiki/%E5%85%B3%E4%BA%8EP%E7%89%88%E7%9A%84PPPoE%E6%8B%A8%E5%8F%B7%E9%97%AE%E9%A2%98) 用wireshark 抓包生成 config.txt，相同学校内容应该相同，内容类似于
...
```/usr/bin/drcom``` : 自己学校可用的心跳认证 python 脚本，[drcom5.2.0 p心跳不对。#82的也不能用 #116](https://github.com/drcoms/drcom-generic/issues/116#issuecomment-250953770) 这个反馈中提供的脚本代码可在自家学校的环境中使用。

```/etc/drcom.conf``` : 使用登录抓包获取到的config.txt文件。

```/usr/bin/pppoe.sh``` : 使用 [p版简略使用和配置说明](https://github.com/drcoms/drcom-generic/wiki/p%E7%89%88%E7%AE%80%E7%95%A5%E4%BD%BF%E7%94%A8%E5%92%8C%E9%85%8D%E7%BD%AE%E8%AF%B4%E6%98%8E) 提到的 [地址](https://github.com/drcoms/drcom-generic/raw/master/custom/pppoe.sh) 替换，最后一行的```exec python /usr/bin/drcom-pppoe.py``` 改为 ```exec python /usr/bin/drcom```
...
dgeibi's blog  [《Drcom 折腾记录》](https://dgeibi.github.io/2016/10/08/drcom/)

Github wiki [《P版简略使用和配置说明》](https://github.com/drcoms/drcom-generic/wiki/p%E7%89%88%E7%AE%80%E7%95%A5%E4%BD%BF%E7%94%A8%E5%92%8C%E9%85%8D%E7%BD%AE%E8%AF%B4%E6%98%8E)[《关于P版的PPPoE拨号问题》](https://github.com/drcoms/drcom-generic/wiki/%E5%85%B3%E4%BA%8EP%E7%89%88%E7%9A%84PPPoE%E6%8B%A8%E5%8F%B7%E9%97%AE%E9%A2%98)
